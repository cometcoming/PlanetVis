...
This utilizes NASA's Spiceypy Python wrapper, a library filled with Python tools that can be used for astronomical data analysis. We use this to model the geometry in our sun-mars-earth system and based on distance, sun illumination, and angle of observation find the single best day in the year of 2026 to observe Mars from Earth. I do provide users with a CSV for their own purposes that is a compilation of all the data gathered in this project, although you cannot use it anywhere in my notebook. 
